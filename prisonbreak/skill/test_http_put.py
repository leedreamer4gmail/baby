...
def main(host: str, port: int = 80, path: str = '/test.txt', data: str = 'test',
         ...
         proxy: Optional[str] = None, use_https: bool = False) -> dict[str, Any]:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--host", default="104.18.27.120", help="HTTP server hostname or IP")
    parser.add_argument("--port", type=parse_port, default=80, help="HTTP server port (default: 80)")
    parser.add_argument("--path", default="/test.txt", help="Upload path (default: /test.txt)")
    parser.add_argument("--test_file", dest="test_file", default=None, help="File to upload")
    ...
    result = main(args.host, args.port, args.path, args.data, args.test_file,
                  args.retry, args.timeout, args.proxy, args.https)
