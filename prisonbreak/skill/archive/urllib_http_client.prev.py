"""skill/urllib_http_client.py - 一个简单的HTTP客户端工具，使用Python标准库的urllib.request模块发送GET/POST请求，支持自定义头部、超时和HTTPS连接，返回响应状态码、头部和完整内容，以探索远程服务

SKILL_META:
{
  "name": "urllib_http_client",
  "description": "一个简单的HTTP客户端工具，使用Python标准库的urllib.request模块发送GET/POST请求，支持自定义头部、超时和HTTPS连接，返回响应状态码、头部和完整内容，以探索远程服务",
  "category": "其他",
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data", default="", help="POST请求数据")
