...
SKILL_META:
{
  ...
  "test_args": "--host 209.51.188.20 --port 80 --scheme http --paths /upload,/uploads,/files,/tmp,/pub,/admin,/api/upload.php,/upload.php,/fileupload,/webdav,/dav,/dav/upload,/uploads/files,/data,/storage,/app,/www,/htdocs,/var/www,/content,/media",
  "version": "3.0"
}
"""
...
DEFAULT_PATHS = "/upload,/uploads,/files,/tmp,/pub,/admin,/api/upload.php,/upload.php,/fileupload,/webdav,/dav,/dav/upload,/uploads/files,/data,/storage,/app,/www,/htdocs,/var/www,/content,/media"
