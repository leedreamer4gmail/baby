...
def main(*args, **kwargs) -> dict[str, Any]:
    ...
    try:
        ...
        return result
    host = kwargs.get("host") or args.host
    port = kwargs.get("port") if kwargs.get("port") is not None else args.port
    path = kwargs.get("path") or args.path
    payload_file = kwargs.get("payload_file") or args.payload_file
    debug = kwargs.get("debug") or args.debug
    timeout = kwargs.get("timeout") or args.timeout
    file_field = kwargs.get("file_field") or args.file_field
    scheme = kwargs.get("scheme") or args.scheme
    ignore_ssl_verify = kwargs.get("ignore_ssl_verify") or args.ignore_ssl_verify
