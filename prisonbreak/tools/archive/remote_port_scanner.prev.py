...
SKILL_META:
{
  ...
  "description": "一个简单的远程端口扫描工具，使用Python标准库（如socket模块）检查指定远程IP的端口是否开放，并返回端口状态和基本响应信息",
  "category": "网络侦察",
  "test_target": "知名DNS服务器8.8.8.8的80和443端口，预期可能无开放端口，但工具应正确执行而不报TypeError",
  "test_args": "--target_ip 8.8.8.8 --ports 80,443",
  "version": "1.0"
}
"""
...
def main(target_ip: str, ports: str) -> dict[str, Any]:
    """扫描指定IP的多个端口"""
    ...
    try:
        ...
        for port in port_list:
            port_result = scan_port(target_ip, port)
...
if __name__ == "__main__":
    ...
    result = main(args.target_ip, args.ports)
